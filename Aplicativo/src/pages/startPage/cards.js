      ...
      {data.map( (item, index)=>{
        ...
        <View style={styles.cards} key={index}>
            ...
            <View style={styles.containerButton}>
                <Button title={"Learn More"} titleStyle={defaultStyles.fontButton} buttonStyle={defaultStyles.button} onPress={() => handlePress("https://www.bostonscientific.com/en-US/about-us.html")}  />
            </View>
        </View>
        ) 
      })}
